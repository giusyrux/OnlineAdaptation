...
struct Skeleton2D_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::hri_msgs::NormalizedPointOfInterest2D_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::hri_msgs::NormalizedPointOfInterest2D_<ContainerAllocator> >::other >  _skeleton_type;
