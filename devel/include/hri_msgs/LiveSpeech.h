...
struct LiveSpeech_
{
  ...
  _header_type header;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _incremental_type;
  _incremental_type incremental;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _final_type;
  _final_type final;
...
struct MD5Sum< ::hri_msgs::LiveSpeech_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xd1d0f996ef223aa8ULL;
  static const uint64_t static_value2 = 0x10d45b3a627e91cdULL;
};
...
struct Printer< ::hri_msgs::LiveSpeech_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::hri_msgs::LiveSpeech_<ContainerAllocator>& v)
  {
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.incremental);
    s << indent << "final: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.final);
    s << indent << "confidence: ";
