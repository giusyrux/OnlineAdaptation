...
struct FacialLandmarks_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::hri_msgs::NormalizedPointOfInterest2D_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::hri_msgs::NormalizedPointOfInterest2D_<ContainerAllocator> >::other >  _landmarks_type;
