...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<LiveSpeech>)))
  ...
  "d1d0f996ef223aa810d45b3a627e91cd")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'LiveSpeech)))
  "Returns md5sum for a message object of type 'LiveSpeech"
  "d1d0f996ef223aa810d45b3a627e91cd")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LiveSpeech>)))
  ...
  (cl:format cl:nil "# This message encodes the live result of a speech recognition process.~%# A series of incremental results might be provided, until a final recognition~%# hypothesis is returned.~%~%Header header~%~%string incremental # incremental recognition results~%string final # final recognised text~%~%float64 confidence # confidence of the final recognised speech, [0-1]~%~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LiveSpeech)))
  "Returns full string definition for message of type 'LiveSpeech"
  (cl:format cl:nil "# This message encodes the live result of a speech recognition process.~%# A series of incremental results might be provided, until a final recognition~%# hypothesis is returned.~%~%Header header~%~%string incremental # incremental recognition results~%string final # final recognised text~%~%float64 confidence # confidence of the final recognised speech, [0-1]~%~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
