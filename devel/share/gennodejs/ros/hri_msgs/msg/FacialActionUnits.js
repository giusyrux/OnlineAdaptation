...
class FacialActionUnits {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('FAU')) {
        this.FAU = initObj.FAU
      }
      else {
        this.FAU = [];
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [FAU]
    bufferOffset = _arraySerializer.float32(obj.FAU, buffer, bufferOffset, null);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [FAU]
    data.FAU = _arrayDeserializer.float32(buffer, bufferOffset, null)
  ...
  static Resolve(msg) {
    ...
    if (msg.FAU !== undefined) {
      resolved.FAU = msg.FAU;
    }
    else {
      resolved.FAU = []
    }
