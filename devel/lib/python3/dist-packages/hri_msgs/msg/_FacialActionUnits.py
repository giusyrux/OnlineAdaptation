...
"""autogenerated by genpy from hri_msgs/FacialActionUnits.msg. Do not edit."""
import codecs
import sys
...
class FacialActionUnits(genpy.Message):
  _md5sum = "7872c889685bdf665183ddf7f24a1dd9"
  _type = "hri_msgs/FacialActionUnits"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# This message the intensity of each actions unit (AU), with their confidence, for a specific face.
#
...
"""
  ...
  __slots__ = ['header','FAU','intensity','confidence']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,FAU,intensity,confidence
    ...
    """
    if args or kwds:
      super(FacialActionUnits, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.FAU))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.FAU = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.FAU = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
